                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="wisataName" name="wisata">
                                    ...
                                    @foreach ($wisata as $item)
                                        <option value="{{ $item->id }}">{{ $item->wisata }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="hargaTiket" name="harga" type="number" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">Jumlah Tiket</label>
                                <input class="form-control" id="jumlahTiket" type="number" name="jumlah">
                            </div>
                            <div class="form-group">
                                <label for="">Total Harga</label>
                                <input class="form-control" id="totalHarga" name="total" type="number" readonly>
                            </div>
                        </div>
                    </div>
                </div>
