...
<head>
    ...
    <link type="image/png" href="template/public/assets/img/favicons/favicon-16x16.png" rel="icon" sizes="16x16">
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg backdrop py-3" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img
                        class="d-inline-block img-fluid align-top" src="assets/img/gallery/logo-icon.png" alt=""
                        width="50" /><span class="text-primary fs-4 ps-2">Rhea</span></a>
                ...
                <div class="navbar-collapse border-top border-lg-0 mt-lg-0 collapse mt-4" id="navbarSupportedContent">
                    <ul class="navbar-nav pt-lg-0 ms-auto pt-2">
                        <li class="nav-item"><a class="nav-link active" href="/" aria-current="page">Home</a></li>
                        <li class="nav-item"><a class="nav-link text-600" href="/#wisata-populer">Wisata</a></li>
                        <li class="nav-item"><a class="nav-link text-600" href="/#tiket-wisata">Tiket Price</a></li>
                    </ul>
                    <form class="ps-lg-5">
                ...
                <div class="row flex-center">
                    <div class="col-auto mb-4">
                        <ul class="list-unstyled list-inline mb-0">
                            <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none"
                                    href="#!">Home</a></li>
                            <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none"
                                    href="#!">Video</a></li>
                            <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none"
                    ...
                    <div class="col-auto">
                        <ul class="list-unstyled list-inline">
                            <li class="list-inline-item me-3"><a class="text-decoration-none" href="#!">
                                    <svg class="bi bi-youtube" xmlns="http://www.w3.org/2000/svg" width="32"
                            ...
                            <li class="list-inline-item me-3"><a class="text-decoration-none" href="#!">
                                    <svg class="bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="32"
                                        height="32" fill="#3984F3" viewBox="0 0 16 16">
                                        <path
